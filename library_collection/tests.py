...
class PublicViewTestCase(TestCase):
    ...
    def testCollectionListViewPagination(self):
        ...
        self.assertContains(response, '<li><a href="?page=2" title="Next Page">&raquo;</a></li>')
        ...
        self.assertContains(response, '<li><a href="?page=7" title="Previous Page">&laquo;</a></li>')
        self.assertContains(response, '<li class="disabled"><a href="?page=8" title="Next Page">&raquo;</a></li>')
        self.assertContains(response, '<li class="active"><a href="#"><span class="sr-only">8</span></a></li>')
        response = self.client.get('/?page=3')
        self.assertContains(response, '<li><a href="?page=2" title="Previous Page">&laquo;</a></li>')
        self.assertContains(response, '<li><a href="?page=4" title="Next Page">&raquo;</a></li>')
