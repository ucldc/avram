...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CollectionCustomFacet'
        db.create_table(u'library_collection_collectioncustomfacet', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('collection', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['library_collection.Collection'])),
            ('facet_field', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('label', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'library_collection', ['CollectionCustomFacet'])


    def backwards(self, orm):
        # Deleting model 'CollectionCustomFacet'
        db.delete_table(u'library_collection_collectioncustomfacet')
    ...
    models = {
        ...
        u'library_collection.collectioncustomfacet': {
            'Meta': {'object_name': 'CollectionCustomFacet'},
            'collection': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['library_collection.Collection']"}),
            'facet_field': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
