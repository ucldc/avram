...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field repository on 'Collection'
        m2m_table_name = db.shorten_name(u'library_collection_collection_repository')
        ...
        db.create_unique(m2m_table_name, ['collection_id', 'repository_id'])


    def backwards(self, orm):
        # Removing M2M table for field repository on 'Collection'
        db.delete_table(db.shorten_name(u'library_collection_collection_repository'))
