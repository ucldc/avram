...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Collection.oai_set_spec'
        db.delete_column(u'library_collection_collection', 'oai_set_spec')


    def backwards(self, orm):
        # Adding field 'Collection.oai_set_spec'
        db.add_column(u'library_collection_collection', 'oai_set_spec',
