...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Campus.position'
        db.add_column(u'library_collection_campus', 'position',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Campus.position'
        db.delete_column(u'library_collection_campus', 'position')
