...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Campus.google_analytics_tracking_code'
        db.add_column(u'library_collection_campus', 'google_analytics_tracking_code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'Collection.local_id'
        db.add_column(u'library_collection_collection', 'local_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1028, blank=True),
                      keep_default=False)

        # Adding field 'Repository.google_analytics_tracking_code'
        db.add_column(u'library_collection_repository', 'google_analytics_tracking_code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Campus.google_analytics_tracking_code'
        db.delete_column(u'library_collection_campus', 'google_analytics_tracking_code')

        # Deleting field 'Collection.local_id'
        db.delete_column(u'library_collection_collection', 'local_id')

        # Deleting field 'Repository.google_analytics_tracking_code'
        db.delete_column(u'library_collection_repository', 'google_analytics_tracking_code')
