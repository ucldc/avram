...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        slug_to_ark_map = { 'UCB': 'ark:/13030/tf0p3009mq',
                'UCD': 'ark:/13030/tf6p3013t7',
                'UCI': 'ark:/13030/tf3f59p4sv',
                'UCLA': 'ark:/13030/tf8z09p95s',
                'UCM': 'ark:/13030/c8668fhk',
                'UCSB': 'ark:/13030/tf7779p82v',
                'UCSC': 'ark:/13030/kt3r29q08x',
                'UCSD': 'ark:/13030/tf5j49p47v',
                'UCSF': 'ark:/13030/tf3x0nb742',
                'UCR': 'ark:/13030/tf1n39p20p',
                }
        for c in orm.Campus.objects.all():
            c.ark = slug_to_ark_map.get(c.slug, 'None')
            print "C.ark", c.ark
