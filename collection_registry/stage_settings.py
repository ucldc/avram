...
ALLOWED_HOSTS = ['registry-stg.cdlib.org', 'dsc-registry2-stg.cdlib.org']
DEBUG = True
...
# For exhibits
EXHIBITS_SOLR_URL = os.environ.get('SOLR_URL')
EXHIBITS_SOLR_API_KEY = os.environ.get('SOLR_API_KEY')
